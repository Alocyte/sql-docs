...
[!NOTE]
If RESTORE FileListOnly targets URL backup file, and the database in the backup file has a different file structure than the SQL instance running the command, it will fail.
